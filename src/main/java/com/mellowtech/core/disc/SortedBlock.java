 ...
 * to the actual keys stored in the array. All sorting, searching, rearaing is
 ...
 * automatially move that space to the unused space section. So using very long
 * keys with heavy insert/delelets can reduce performance.<br>
 * <br>
...
public class SortedBlock {
   ...
   */
  public void setBlock(byte[] block, ByteStorable keyType, boolean newBlock,
  ...
  public void sort(boolean mergeSort) {
    ...
    if (mergeSort)
      ...
      com.mellowtech.core.sort.Sorters.quickSort(toSort);
  ...
  private static void putKeysPrevious(SortedBlock[] blocks, int index,
      int optimal) {
    int blockBytes;
    ByteStorable current;
    int diff;
  ...
  private static void getKeysPrevious(SortedBlock[] blocks, int index,
      int optimal) {
    int blockBytes;
    ByteStorable current;
    int diff;
  ...
  private void mergeBlockSimple(SortedBlock other){
