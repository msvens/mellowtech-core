 ...
 * @version 1.0
 */
public class StorableReadChannel {

  private ByteStorable mTemplate;
   ...
   */
  public StorableReadChannel(ReadableByteChannel rbc, ByteStorable template) {
    mTemplate = template;
    mRbc = rbc;
  ...
  public ByteStorable next() throws IOException {
    ...
    return mTemplate.fromBytes(mBuffer);
  } // next
   ...
   */
  public void setTemplate(ByteStorable pTemplate) {
    mTemplate = pTemplate;
  } // setTemplate
}
