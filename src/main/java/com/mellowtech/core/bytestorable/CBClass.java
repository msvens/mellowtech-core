...
public class CBClass extends ByteStorable <Class> {
  ...
  /* (non-Javadoc)
   * @see com.mellowtech.core.bytestorable.ByteStorable#toBytes(java.nio.ByteBuffer)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.mellowtech.core.bytestorable.ByteStorable#byteSize(java.nio.ByteBuffer)
   */
  @Override
