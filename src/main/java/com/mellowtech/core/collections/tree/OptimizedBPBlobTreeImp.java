...
public class OptimizedBPBlobTreeImp<K extends ByteComparable, V extends ByteStorable>
  ...
  FileChannel blobs;
  OptimizedBPTreeImp <K, BlobPointer> tree;
  V template;
  String fName;


  public OptimizedBPBlobTreeImp(String fName, K keyType, V valueType) throws Exception {
  ...
  public OptimizedBPBlobTreeImp(String fName, K keyType, V valueType, int indexSize, int valueSize) throws IOException {
