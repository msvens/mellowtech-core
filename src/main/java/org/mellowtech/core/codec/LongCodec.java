 ...
 * @since 4.0.0
 */
public class LongCodec implements BCodec<Long> {
  ...
  @Override
  public void to(Long value, ByteBuffer bb) {
    bb.putLong(value);
  }

  @Override
  public Long from(ByteBuffer bb) {return bb.getLong();}
