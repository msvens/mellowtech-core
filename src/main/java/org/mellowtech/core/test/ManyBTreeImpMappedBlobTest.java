...
import org.mellowtech.core.collections.impl.BTreeImp;
 ...
 * @since 2017-01-03
 */
public class ManyBTreeImpMappedBlobTest {
  ...
  public ManyBTreeImpMappedBlobTest() {


  }

  public String dir;
  BTreeImp<String, Integer> tree;
  ...
  public static void main(String[] args){
    try {
      ManyBTreeImpMappedBlobTest mht = new ManyBTreeImpMappedBlobTest();
     /*mht.loadFaultyManyIteratorRangeExclusive();
      mht.setup();
      mht.putMany();
      System.out.println(mht.manyIteratorRangeExclusive());
      mht.teardown();*/
  ...
  public BTreeImp<String, Integer> init(String fileName, int valueBlockSize,
  ...
  public void loadFaultyManyIteratorRangeExclusive() throws Exception {
    loadWords("manyIteratorRangeExclusiveBroken.bs");
  }
