...
import org.mellowtech.core.disc.blockfile.BlockWithId;
 ...
 */
public class BlockWithIdTest {

  @Test
  public void test() {
    BlockWithId block = new BlockWithId(128, new CBString());
    CBString cs[] = new CBString[10];
    cs[0] = new CBString("h* 0");
    cs[1] = new CBString("h* 1");
    cs[2] = new CBString("h* 2");
    cs[3] = new CBString("h* 3");
    cs[4] = new CBString("h* 4");
    cs[5] = new CBString("h* 5");
    cs[6] = new CBString("h* 6");
    cs[7] = new CBString("h* 7");
    cs[8] = new CBString("h* 8");
    cs[9] = new CBString("h* 9");


    for (int i = 0; i < cs.length; i++)
      Assert.assertTrue(block.insert(i, cs[i]));
    ...
    Assert.assertNotNull(block.remove(3));
    ...
    block.toBytes(bb);
    bb.flip();
    BlockWithId block2 = (BlockWithId) block.fromBytes(bb);
