...
public class BCBufferTest {
  ...
  public BCBuffer<String, CBString> newBlock() {
  ...
  public void zeroMergeBlock(){
    BCBuffer <String, CBString> other = newBlock();
  ...
  public void zeroReopen(){
    ...
    BCBuffer <String, CBString> other = new BCBuffer<>(bytes, new CBString());
  ...
  public void oneSplitBlock(){
    putFirst();
    BCBuffer<String, CBString> nb = sb.split();
    Assert.assertEquals(0, sb.getNumberOfElements());
  ...
  public void tenReopen(){
    putAll();
    ByteBuffer bytes = sb.getBlock();
    BCBuffer <String, CBString> other = new BCBuffer<String,CBString>(bytes, new CBString());
