 ...
 *
 */
@DisplayName("A DiscBasedBlobHashMap")
class DiscBasedBlobHashMapTest extends DiscMapTemplate {

  @Override
  DiscMap<String, Integer> init() throws Exception {
    String fName = "discBasedBlobHashMap";
    ...
    builder.bucketSize(VAL_BLK_SIZE).maxBuckets(VAL_BLKS).blobValues(true).inMemory(false);
