...
public class HybridTreeTest extends BTreeTemplate {
  ...
  public BTree<String, CBString, Integer, CBInt> init(String fileName, int valueBlockSize,
    ...
    RecordFileBuilder rfb = new RecordFileBuilder().blockSize(valueBlockSize).maxBlocks(maxValueBlocks);
    RecordFile rf = rfb.build(Paths.get(fileName));
    return new HybridTree<>(CBString.class, CBInt.class, rf,false);
  }
